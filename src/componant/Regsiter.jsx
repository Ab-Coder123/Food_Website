...
import "../js/login"
const Regsiter = () => {
  let switchCtn =  useRef(null);
  let switchC1 =  useRef(null);
let switchC2 =  useRef(null);
let switchCircle =  useRef(null);
let switchBtn =  useRef(null);
let aContainer=  useRef(null);
let bContainer=  useRef(null);
let allButtons =  useRef(null);
useEffect (()=> {
...
<div className="main">
  <div className="container a-container" id="a-container" ref={aContainer}>
    <form className="form" id="a-form" method="" action="">
      ...
      <button className="form__button button submit" ref={allButtons}>SIGN UP</button>
    </form>
  </div>
  <div className="container b-container" id="b-container" ref={bContainer}>
    <form className="form" id="b-form" method="" action="">
      ...
      <button className="form__button button submit" ref={allButtons}>SIGN IN</button>
    </form>
  </div>
  <div className="switch" id="switch-cnt" ref={switchCtn}>
    <div className="switch__circle" ref={switchCircle} />
    <div className="switch__circle switch__circle--t" ref={switchCircle} />
    ...
    <div className="switch__container is-hidden" id="switch-c2" ref={switchC2}>
      ...
      <button className="switch__button button switch-btn" ref={switchBtn}>SIGN UP</button>
    </div>
  </div>
</div>
